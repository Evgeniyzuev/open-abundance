...
const checks = [
  ...
  ["compact skill card UI", ui.includes("nextCheck") && ui.includes("🔼{skill.effectiveLevel}") && ui.includes("nextCheck.currentValue") && ui.includes("nextCheck.threshold") && !ui.includes("currentCheck")],
