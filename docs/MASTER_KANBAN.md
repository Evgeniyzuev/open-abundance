...
- **Изменения:** `first_core_path`, шаги/action views, только Core-награды, рекомендованный порядок без prerequisite-блокировок, локальные category/icon visuals, отдельный UI-блок прогресса и first-party funnel events.
