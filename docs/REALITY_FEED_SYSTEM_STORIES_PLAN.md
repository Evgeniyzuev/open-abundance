...
Статус: тексты и server-backed content slice реализованы 2026-07-19; отдельный экран профиля системного аккаунта остается следующим UI-срезом.
...
- Еще не реализовано: переход по системному автору в отдельный профиль со всеми главами и возврат в ленту с сохранением позиции.
