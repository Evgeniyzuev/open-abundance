...
The shared mobile UI rule—compact overview, on-demand details, then one clear action—and the staged redesign of Challenges, Home, and Nova live in [docs/ENGAGING_INTERFACE_PLAN.md](docs/ENGAGING_INTERFACE_PLAN.md).
