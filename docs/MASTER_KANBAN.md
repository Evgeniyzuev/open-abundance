...
**PILOT-001 — подготовить пакет набора и каталог из десяти заданий.** Ответственный: Codex. Статус: Очередь. Сообщение и карточки ещё не подготовлены; наличие плана не считается приглашением или запуском.

Пакет должен дать основателю готовый текст приглашения, сценарий разговора и задания с deliverable, приёмкой и заранее известной Core-наградой. После подготовки основатель сможет начать набор параллельно единственной активной реализации продуктового маршрута.
...
|---|---|---|---|---|---|---|---|
| DOC-001 / организация | Общий трекер и канонический план пилота | Codex | Подтверждено | Утверждённый пользователем план документации | Следующая задача — PILOT-001 | Документы согласованы, прежние доказательства сохранены | [План пилота](PILOT_30_DAY_PLAN.md); 2026-09-09: UTF-8, 71 локальная ссылка, параметры пилота, сохранность архива и `git diff --check` проверены; продуктовый QA этим не подтверждается |
| PILOT-001 / подготовка | Приглашение, сценарий разговора и десять карточек заданий | Codex | Очередь | Согласованный объём пилота | Подготовить пакет для основателя | В каждой карточке есть результат, proof, награда и ответственный за приёмку | Пока отсутствует; требования в [плане пилота §2–3](PILOT_30_DAY_PLAN.md#2-порядок-подготовки-и-набора) |
...
Ближайшая последовательность: PILOT-001 → OPS-001 и DEV-001; FIN-001 → FIN-002; после их завершения OPS-002 → OPS-003. Работы могут идти параллельно только в пределах WIP-ограничений ниже.
