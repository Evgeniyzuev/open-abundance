...
export function detectAppearancePreference(): { uiScale: UiScale; colorTheme: ColorTheme } {
  if (typeof window === "undefined") {
    return { uiScale: DEFAULT_UI_SCALE, colorTheme: DEFAULT_COLOR_THEME };
  }
...
export function applyAppearancePreference(uiScale: UiScale, colorTheme: ColorTheme): void {
...
function updateThemeColor(colorTheme: ColorTheme): void {
  const themeColor = resolveColorTheme(colorTheme) === "dark" ? "#111318" : "#f2f2f7";
