...
- [x] **Core redemption safeguard (технический контур):** obligations на UTC-период, 24-часовой breach detector, DB-trigger неприкосновенности Core, idempotent redemption request/status и service-role worker RPC; rollout/юридический допуск остаются отдельным gate. План: `docs/CORE_REDEMPTION_SAFEGUARD_PLAN.md`.
