...
- [x] **Единый onboarding:** 2026-07-20 первое знакомство упрощено до трех экранов `миссия -> истории -> программа 20 уровней` без форм и оговорок; первый экран позиционирует Abundance как ИИ-инструмент создания изобилия и быстрого движения к желаниям. Добавлены отдельные яркие иллюстрации, CTA расчета ведет в доступный гостю Core-калькулятор, альтернативный CTA — к первому заданию. Визуальный эталон закреплен в `docs/VISUAL_LANGUAGE.md`.
