...
Обмен Wallet ↔ RUB с банковским переводом, отдельным фондом покрытия и Core/Trust risk limits не является частью этого Marketplace. Его канонический план: [P2P Wallet ↔ RUB](P2P_WALLET_FIAT_PLAN.md).
