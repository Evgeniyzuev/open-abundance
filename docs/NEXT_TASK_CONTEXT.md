...
- Пять конкретных переписанных RU draft-постов сохранены в `docs/REALITY_FEED_DEMO_STORIES_NARRATIVE_DRAFT.md`; они пока не перенесены в Supabase, EN-версии и отдельное решение по миграции остаются следующими редакционными шагами.
